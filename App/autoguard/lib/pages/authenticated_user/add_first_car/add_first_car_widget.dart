...
import 'add_first_car_model.dart';
export 'add_first_car_model.dart';

class AddFirstCarWidget extends StatefulWidget {
  const AddFirstCarWidget({Key? key}) : super(key: key);

  @override
  _AddFirstCarWidgetState createState() => _AddFirstCarWidgetState();
}

class _AddFirstCarWidgetState extends State<AddFirstCarWidget> {
  late AddFirstCarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddFirstCarModel());
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFFEDE5E5),
            ...
            children: [
              Row(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/carModelBlack2.png',
                      width: 350.0,
                      height: 200.0,
                      fit: BoxFit.fitWidth,
                    ),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  validator:
                      _model.modelControllerValidator.asValidator(context),
                ),
              ),
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  obscureText: false,
                  decoration: InputDecoration(
                    labelText: 'V.I.N.  (vehicle identification number)...',
                    labelStyle: FlutterFlowTheme.of(context).labelMedium,
                    hintStyle: FlutterFlowTheme.of(context).labelMedium,
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                  ...
                  style: FlutterFlowTheme.of(context).bodyMedium,
                  validator: _model.vinControllerValidator.asValidator(context),
                ),
              ),
              Row(
                mainAxisSize: MainAxisSize.max,
                  ...
                  onPressed: () async {
                    await VehiclesRecord.collection
                        ...
                        .set(createVehiclesRecordData(
                          ...
                          imageLink:
                              'https://storage.cloud.google.com/autoguard-vehicles-images/WolfswagenScirocco.png?authuser=1',
                        ));
                    await showDialog(
                      context: context,
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('Success!'),
                          content: Text('Vehicle added to your list!'),
                          actions: [
                            TextButton(
                              onPressed: () =>
